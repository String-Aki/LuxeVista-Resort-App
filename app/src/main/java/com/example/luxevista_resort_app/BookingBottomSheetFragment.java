...
public class BookingBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public static BookingBottomSheetFragment newInstance(String suiteName) {
    ...
    private void saveBookingToFirestore() {
        ...
        Booking booking = new Booking(userId, this.suiteName, checkIn, checkOut, adultsCount, childrenCount, "Requested");
